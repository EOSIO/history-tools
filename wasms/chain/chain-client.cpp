...
extern "C" void describe_query_request() { eosio::set_output_data(eosio::make_json_schema<chain_query_request>()); }

extern "C" void describe_query_response() { eosio::set_output_data(eosio::make_json_schema<chain_query_response>()); }
...
extern "C" void decode_query_response() { //
    eosio::set_output_data(to_json(eosio::unpack<chain_query_response>(eosio::get_input_data())));
}
