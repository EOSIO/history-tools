...
extern "C" void describe_query_request() { eosio::set_output_data(eosio::make_json_schema_with_defs<token_query_request>()); }
extern "C" void describe_query_response() { eosio::set_output_data(eosio::make_json_schema_with_defs<token_query_response>()); }
